...
# Test Cases
test_cases=[
    (["This", "is", "an", "example", "of", "text", "justification."], 20, ['This  is  an example', 'of              text', 'justification.      ']),
    (["What","must","be","acknowledgment","shall","be"], 20, ['What     must     be', 'acknowledgment shall', 'be                  ']),
...
solution = Solution()
for idx, (words, maxWidth, expected) in enumerate(test_cases):
